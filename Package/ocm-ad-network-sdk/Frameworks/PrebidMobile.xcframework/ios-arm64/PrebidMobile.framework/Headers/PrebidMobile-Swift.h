...
+ (id <PBMCreativeViewabilityTracker> _Nonnull)PBMCreativeViewabilityTrackerWithView:(UIView * _Nonnull)view pollingTimeInterval:(NSTimeInterval)pollingTimeInterval onExposureChange:(void (^ _Nonnull)(id <PBMCreativeViewabilityTracker> _Nonnull, id <PBMViewExposure> _Nonnull))onExposureChange SWIFT_WARN_UNUSED_RESULT;
+ (id <PBMCreativeViewabilityTracker> _Nonnull)CreativeViewabilityTrackerWithCreative:(id <PBMAbstractCreative> _Nonnull)creative SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic) PBMMRAIDState _Nonnull mraidState;
...
- (void)addFriendlyObstructionsToMeasurementSession:(PBMOpenMeasurementSession * _Nonnull)session;
@end
...
@property (nonatomic, strong) PBMORTBBidResponseExtPrebid * _Nullable extPrebid;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nonnull instancetype)initWithJsonDictionary:(NSDictionary<NSString *, id> * _Nonnull)jsonDictionary OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nonnull jsonDictionary;
...
@property (nonatomic, strong) PBMOpenMeasurementSession * _Nonnull measurementSession;
@property (nonatomic, strong) PBMOpenMeasurementWrapper * _Nonnull measurementWrapper;
